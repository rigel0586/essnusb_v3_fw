...
export GENIE_XCROSS=${fw_directory}/framework/workspace/genie/download/genie_xsec/v3_06_00/NULL/G1802a00000-k250-e1000/data/gxspl-FNALsmall.xml
export GENIE_XCROSS_BIG=${fw_directory}/framework/workspace/genie/download/genie_xsec/v3_06_00/NULL/G1802a00000-k250-e1000/data/gxspl-NUbig.xml
