...
G4LogicalVolume* WCSimGeometry::ConstructEggShapedHyperK()
{
  ...
  G4LogicalVolume* eggShapedHyperKLV
    = new G4LogicalVolume(new G4Box("EggShapedHyperKBox",
                                    ...
                                    FindMaterial("G4_AIR"),
                                    "EggShapedHyperK");
  eggShapedHyperKLV->SetVisAttributes(G4VisAttributes(false));
...
// -----------------------------------------------------------------
  ...
  waterTankLV->SetVisAttributes(G4VisAttributes(false));
...
G4VSolid* WCSimGeometry::ConstructHalf(G4double waterTank_Radius,
...
G4LogicalVolume* WCSimGeometry::ConstructRadialPMT(G4bool top,
                                                               G4double radius,
                                                               G4double height,
                                                               G4double offset,
                                                               G4double expose,
                                                               ...
                                                               G4double pitchZ)
{
  ...
  G4LogicalVolume* pmtAnnulusLV
    = new G4LogicalVolume(new G4Tubs("PMTAnnulus",
                          ...
                          "PMTAnnulus");
  pmtAnnulusLV->SetVisAttributes(G4VisAttributes(false));
...
//     blackSheetALV->SetVisAttributes(new G4VisAttributes(G4Colour(0,0.5,1.)));
  ...
  G4LogicalVolume* pmtRingLV
    = new G4LogicalVolume(new G4Tubs("PMTRing",
                          ...
                          FindMaterial("G4_WATER"),
                          "PMTRings");
  pmtRingLV->SetVisAttributes(G4VisAttributes(false));
  ...
  G4LogicalVolume* pmtCellLV
    = new G4LogicalVolume(new G4Tubs("PMTCell",
                          ...
                          FindMaterial("G4_WATER"),
                          "PMTCell");
  pmtCellLV->SetVisAttributes(G4VisAttributes(false));
...
G4LogicalVolume* WCSimGeometry::ConstructEndWallPMT()
{
  G4LogicalVolume* pmtCellLV
...
//      if (dv.mag() > innerPMT_BotR - innerPMT_Radius) break;
    ...
    G4LogicalVolume* pmtSlabLV
      = new G4LogicalVolume(new G4Box("PMTSlab",
                            ...
                            FindMaterial("G4_WATER"),
                            "PMTSlab");
    pmtSlabLV->SetVisAttributes(G4VisAttributes(false));
...
G4LogicalVolume* WCSimGeometry::ConstructCeilingPMT(G4bool top, 
                                                                G4double width,
                                                                G4double height,
                                                                G4double pitch,
                                                                G4double size)
...
//     blackSheetYLV->SetVisAttributes(new G4VisAttributes(G4Colour(0,0.5,1.)));
  ...
  G4LogicalVolume* pmtSliceLV
      = new G4LogicalVolume(new G4Box("PMTSlice",
                            ...
                            FindMaterial("G4_WATER"),
                            "PMTSlab");
  pmtSliceLV->SetVisAttributes(G4VisAttributes(false));
 ...
 */
G4Material* WCSimGeometry::FindMaterial(G4String name)
{
