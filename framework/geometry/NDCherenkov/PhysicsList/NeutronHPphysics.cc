...
ClassImp(esbroot::geometry::ndcherenkov::NeutronHPphysics)
...
void NeutronHPphysics::ConstructProcess()
{
  ...
  process1->AddDataSet(new G4NeutronElasticXS());
  model1a->SetMaxEnergy(2*GeV);
  ...
  process2->AddDataSet(new G4NeutronInelasticXS()); 
