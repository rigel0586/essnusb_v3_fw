 ...
 ********************************************************************************/
#ifndef ESBROOT_NDCHERENKOVDATAPOINT_POINT_H
#define ESBROOT_NDCHERENKOVDATAPOINT_POINT_H 1
...
class NDCherenkovDataPoint : public TObject
{

  public:

    /** Default constructor **/
    NDCherenkovDataPoint();
    ...
    * @param eventID        Index of event for MCTrack
     ...
     **/
    NDCherenkovDataPoint(Int_t eventID
          , Int_t trackID
          , Int_t parentID
          , Int_t pdg
    ...
    ClassDef(NDCherenkovDataPoint,1)
  private:
    /** Copy constructor **/
    NDCherenkovDataPoint(const NDCherenkovDataPoint& point);
    NDCherenkovDataPoint operator=(const NDCherenkovDataPoint& point);
...
inline void NDCherenkovDataPoint::SetMomentum(const TVector3& mom)
{
    fmomentum = mom;
    fPx = mom.Px();
    fPy = mom.Py();
...
inline void NDCherenkovDataPoint::SetPosition(const TVector3& pos)
{
    fposition = pos;
    fX = pos.X();
    fY = pos.Y();
