void compare_nuance_tmva(TString nuanceFile = "/home/rigel/opt/ESSnuSB/ESSnuSB-soft/EsbMacro/tests/nuFluxHist/data_04_01_2021/SFGD_WC_crossover_events_220107/crossover_pos_numu.dat"            // Path to statsRoot.root generated from simulate_3_MC_lepton_stats.C
                        , TString tmvaFile = "/home/rigel/opt/ESSnuSB/ESSnuSB-soft/EsbMacro/tests/nuFluxHist/data_04_01_2021/nuFlux100km_250kAp_mu_tmva.dat"      // output file where to write the nuance formatted data
                        )                                     
{
    ...
    fcanvas->Draw();
    fcanvas->Write(); ;
    fcanvas->SaveAs("hist_Nuance_TMlpANN pos_mu histogram.png");
    ...
    fcanvas->Draw();
    fcanvas->Write(); ;
    fcanvas->SaveAs("hist_Nuance_BTG pos_mu histogram.png");
