...
void tmva_1_ex_total_ph_CC_train( TString myMethodList = "" , TString inFileName = "tmva_data.root")
{
   ...
   // Add input variables
   dataloader->AddVariable( "totalPhotonsX", "Total photons X", "units", 'F' );
   dataloader->AddVariable( "totalPhotonsY", "Total photons Y", "units", 'F' );
   dataloader->AddVariable( "totalPhotonsZ", "Total photons Z", "units", 'F' );
