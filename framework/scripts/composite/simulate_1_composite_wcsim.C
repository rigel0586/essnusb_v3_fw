void simulate_1_composite_wcsim(Int_t nEvents = 3)
{
    ...
    ssOut << "/simulation/composite_sim_wcsim_output.root";
    ...
    seventsData << "/simulation/composite_wcsim_eventsData.dat";
    ...
    generators::generic::GenericGenieGenerator* partGen = new generators::generic::GenericGenieGenerator(
            fluPos // Vertex position generator
		        , wcsimDetector->GetName()    // Name of the volume to generate the neutrino events
