#include "reconstruction/SuperFGD/FgdGraphStats.hpp"
ClassImp(esbroot::reconstruction::superfgd::FgdGraphStats)
...
bool FgdGraphStats::Exec(int eventId, TClonesArray* data)
{
    static int event = 0;
    try
    {
