#include "generic/GenieGenerator.h"
ClassImp(esbroot::generators::generic::GenieGenerator)
...
{
    // From essnusb comment: Not using fairroot, but worth checking
...
void GenieGenerator::WriteToOutputFile(const genie::EventRecord* event, Bool_t flaGkeepThrowing )
{
 ...
 GenieGenerator* GenieGenerator::CloneGenerator() const
 {
